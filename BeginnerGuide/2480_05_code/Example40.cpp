...
class Example40FrameListener : public Ogre::FrameListener
{
private:
...
public:
	...
	Example40FrameListener(Ogre::SceneNode* node,Ogre::Entity* ent,RenderWindow* win,Ogre::Camera* cam)
	{
		_node = node;
...
class Example40 : public ExampleApplication
{
private:
...
public:
	...
	{
		Ogre::FrameListener* FrameListener = new Example40FrameListener(_SinbadNode,_SinbadEnt,mWindow,mCamera);
