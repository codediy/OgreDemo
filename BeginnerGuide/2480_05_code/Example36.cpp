...
class Example36FrameListener : public Ogre::FrameListener
{
private:
...
public:
	...
	Example36FrameListener(Ogre::SceneNode* node,Ogre::Entity* ent,RenderWindow* win,Ogre::Camera* cam)
	{
		_node = node;
...
class Example36 : public ExampleApplication
{
private:
...
public:
	...
	{
		Ogre::FrameListener* FrameListener = new Example36FrameListener(_SinbadNode,_SinbadEnt,mWindow,mCamera);
