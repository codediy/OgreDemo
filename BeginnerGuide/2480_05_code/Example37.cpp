...
class Example37FrameListener : public Ogre::FrameListener
{
private:
...
public:
	...
	Example37FrameListener(Ogre::SceneNode* node,Ogre::Entity* ent,RenderWindow* win,Ogre::Camera* cam)
	{
		_node = node;
	...
	bool frameStarted(const Ogre::FrameEvent  &evt)
	{
		...
		_aniStateTop->addTime(evt.timeSinceLastFrame * _animationFactor);
		return true;
	}
};


class Example37 : public ExampleApplication
{
private:
...
public:
	...
	{
		Ogre::FrameListener* FrameListener = new Example37FrameListener(_SinbadNode,_SinbadEnt,mWindow,mCamera);
