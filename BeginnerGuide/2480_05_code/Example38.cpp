...
class Example38FrameListener : public Ogre::FrameListener
{
private:
...
public:
	...
	Example38FrameListener(Ogre::SceneNode* node,Ogre::Entity* ent,RenderWindow* win,Ogre::Camera* cam)
	{
		_node = node;
...
class Example38 : public ExampleApplication
{
private:
...
public:
	...
	{
		Ogre::FrameListener* FrameListener = new Example38FrameListener(_SinbadNode,_SinbadEnt,mWindow,mCamera);
