...
class Example29FrameListener : public Ogre::FrameListener
{
private:
...
public:
	...
	Example29FrameListener(Ogre::SceneNode* node,RenderWindow* win)
	{
		_node = node;
...
class Example29 : public ExampleApplication
{
private:
...
public:
	...
	{
		Ogre::FrameListener* FrameListener = new Example29FrameListener(_SinbadNode,mWindow);
