...
class Example32FrameListener : public Ogre::FrameListener
{
private:
...
public:
	...
	Example32FrameListener(Ogre::SceneNode* node,RenderWindow* win,Ogre::Camera* cam)
	{
		_node = node;
		_Cam = cam;
...
class Example32 : public ExampleApplication
{
private:
...
public:
	...
	{
		Ogre::FrameListener* FrameListener = new Example32FrameListener(_SinbadNode,mWindow,mCamera);
