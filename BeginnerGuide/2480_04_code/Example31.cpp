...
class Example31FrameListener : public Ogre::FrameListener
{
private:
...
public:
	...
	Example31FrameListener(Ogre::SceneNode* node,RenderWindow* win,Ogre::Camera* cam)
	{
		_node = node;
		_Cam = cam;
...
class Example31 : public ExampleApplication
{
private:
...
public:
	...
	{
		Ogre::FrameListener* FrameListener = new Example31FrameListener(_SinbadNode,mWindow,mCamera);
